...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-8">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="actions">
                                    <?= $this->Html->link(__('View'), ['controller' => 'Users', 'action' => 'view', $generalDirector->id], ["class" =>"btn btn-sm btn-primary"]) ?>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
            ...
            <div class="row">
                <div class="col justify-content-center">
                    <h3><?= __('Division Managers in your department') ?></h3>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="actions">
                                    <?= $this->Html->link(__('View'), ['controller' => 'Users', 'action' => 'view', $divisionDirector->id], ["class" =>"btn btn-sm btn-primary"]) ?>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
            ...
            <div class="row">
                <div class="col justify-content-center">
                    <h3><?= __('Sellers in your department') ?></h3>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="actions">
                                    <?= $this->Html->link(__('View'), ['controller' => 'Users', 'action' => 'view', $sellers->id] , ["class" =>"btn btn-sm btn-primary"]) ?>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
